...
var appid = 'A6900336988686',
    appkey = '48BC3EB7-BAD9-098C-0ACA-5C5526B77DE0';
...
Resource.prototype.Factory = function(modelName) {
    ...
    Object.keys(actions).forEach(function(name) {
        if (modelName != "user" && ["login", "logout", "verify", "reset", "sendvercode", "checkvercode", "resetByMobile"].indexOf(name) != -1) {
            return; }
